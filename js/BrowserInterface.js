 ...
 * GitHub: mmenavas
 * Twitter: @menamaximo
 * Modified Author: Morgan Sandler
...
*/
  ...
  reset.addEventListener('click', handleSettingsSubmission);
   ...
   var info = document.getElementById('memory--settings-info');
  var handleInfoSubmission = function (event) {
    event.preventDefault();

    var selectWidget = document.getElementById("memory--settings-infos").valueOf();
    var opt = selectWidget.options[selectWidget.selectedIndex].value;
  ...
  reset.addEventListener('click', handleInfoSubmission);
